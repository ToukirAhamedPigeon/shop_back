...
namespace shop_back.App.Authorization
{
    public abstract class BasePermissionAttribute : TypeFilterAttribute
    {
        ...
        {
            Arguments = new object[] { permissions == null ? new List<string>() : new List<string>(permissions), relation };
        }
    }

    public class HasPermissionAnyAttribute : BasePermissionAttribute
    {
        public HasPermissionAnyAttribute(params string[] permissions) : base(permissions, PermissionRelation.Or) { }
    }

    public class HasPermissionAllAttribute : BasePermissionAttribute
    {
        public HasPermissionAllAttribute(params string[] permissions) : base(permissions, PermissionRelation.And) { }
    }
}
